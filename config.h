...
static const char col_cyan[] =
    "#870000"; /* border color focused windows and tags */
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_y, spawn, CMD("alacritty -e devour ytfzf -D")},
    {MODKEY, XK_KP_End, spawn,
     CMD("st -e lynx -cfg=~/.lynx/lynx.cfg -lss=~/.lynx/lynx.lss "
         "gopher://distro.tube")},
    {MODKEY, XK_s, spawn, CMD("alacritty -e ncspot")},
    ...
    {MODKEY | ShiftMask, XK_KP_End, spawn,
     CMD("st -e ~/.config/vifm/scripts/vifmrun")},
    ...
    {MODKEY | ShiftMask, XK_KP_Page_Up, spawn,
     CMD("st -e vim /home/dt/dwm/config.h")},
    ...
    {MODKEY | ControlMask, XK_KP_Right, spawn,
     CMD("st -e httping -KY --draw-phase localhost")},
